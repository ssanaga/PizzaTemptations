...
const router = {
  ...
  "/create-order-api": () =>
    requireAuth(() => showContent("content-create-order"), "/create-order-api"),

  "/order-history-api": () =>
    requireAuth(() => showContent("content-order-history"), "/order-history-api"),
...
const updateUI = async () => {
  try {
    ...
    if (isAuthenticated) {
      ...
      document.getElementById("token-data").innerText = token;
      //document.getElementById("Auth0UserId").innerText = user.sub;
      ...
      eachElement(".user-id", (e) => (e.innerText = user.sub));
